    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
      ...
      if ($_FILES['image']['error'] === 4) {
        ...
        ";
          ...
          $sql = "UPDATE `tbl_staff` SET `pic`='$newFileName',
           `name`='$name',`gender`='$gender',`mobile`='$mobile',`email`='$email',`dob`='$dob',`pob`='$pob' WHERE `id` = '$id'";
        ...
        <form class="needs-validation" novalidate method="POST" enctype="multipart/form-data">
          <div class="card-body">
            <div class="row g-3">
              ...
              <div class="col-md-6">
                <img src="../../image/<?php echo $pic ?>" class="rounded-3 float-start" alt="" style="height: 200px;">
              </div>
            </div>
          </div>
